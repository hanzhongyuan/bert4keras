...
config_path = 'F:\model\GPT_base model\chinese_nezha_gpt_L-12_H-768_A-12/config.json'
checkpoint_path = 'F:\model\GPT_base model\chinese_nezha_gpt_L-12_H-768_A-12/gpt.ckpt'
dict_path = 'F:\model\GPT_base model\chinese_nezha_gpt_L-12_H-768_A-12/vocab.txt'
...
class ArticleCompletion(AutoRegressiveDecoder):
    ...
    def generate(self, text, n=5):
        ...
        return text + tokenizer.decode(results)
